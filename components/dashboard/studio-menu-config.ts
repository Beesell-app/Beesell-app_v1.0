...
export const FEATURES: FeatureItem[] = [
  ...
  // ───────────── STUDIO — Image ─────────────
  { id:'ai-image-generator', name:'AI Image Generator', label:'AI Image Generator', description:'Generate foto produk, banner & konten visual dari teks.', icon:'🖼️', href:'/content/image',                category:'studio', subCategory:'image', tierRequired:'starter', isMetered:true, credit:5,  badge:'POPULAR', sortOrder:5 },
